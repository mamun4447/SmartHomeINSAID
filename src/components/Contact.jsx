...
const Contact = () => {
  ...
  return (
    <div className="bg-slate-100 container mx-auto py-5" id="contact">
      ...
      >
        <input
          type="text"
          className="input w-full px-5 shadow-md border-none  my-5  text-black"
          name="Name"
        ...
        />
        <textarea
          className="input w-full p-5 h-32 shadow-md  my-5 text-black"
          name="text"
